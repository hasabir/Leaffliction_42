...
class Train():
    ...
    def _augment_dataset(self, target_dir_path, train_ds):
        ...
        augmented_dir = os.path.join(
            self.output_dir, "augmented_train_directory")
        augment_dataset(directory_path=target_dir_path,
    ...
    def _get_dataset_partitions_tf(self, ds,
                                   train_split=0.8,
                                   val_split=0.2,
                                   shuffle=True,
                                   shuffle_size=10000):
    ...
    def _check_dataset_path(self, dataset_path):
        if dataset_path is None:
            raise ValueError(
                "Dataset not loaded. Please load the dataset before training.")
